...
export default function SingleBookDetails({}: Props): ReactElement {
  ...
  const addUserReview=()=>{
    ...
    // if logged in then only allow this operation 
        ...
        <div className="row">
          ...
          <div className="col price-col">
            <div className="price-section">
              ...
              <div className="row price-row">
                <button className="add-to-cart detail-btn"><i className="fa fa-shopping-cart" aria-hidden="true"></i> Add to Cart </button>
              </div>
              <div className="row price-row">
